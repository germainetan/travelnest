    ...
    created() {
        ...
        axios.get(`http://localhost:8000/booking/${this.bookingid}`)
            .then(response => { 
                ...
                this.startdate = "Start Date: " + response.data.data.start_datetime
                this.enddate = "End Date: " + response.data.data.end_datetime
                this.bookingstatus = response.data.data.booking_status
